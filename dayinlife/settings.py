"""
Django settings for dayinlife project.
...
SECRET_KEY = 'y=z^pyemm9@x8i6p(^^kv3a4!32i=rjohh&ym2juxyt2d-h(rs'
...
WSGI_APPLICATION = 'dayinlife.wsgi.application'
